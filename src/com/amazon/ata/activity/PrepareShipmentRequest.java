...
public class PrepareShipmentRequest {
    ...
    */
    ...
    /**
     * Instantiates a new PrepareShipmentRequest object.
     * @param asin The item's unique identifier - asing - (Amazon Standard Identification Number -
     *             10 alphanumeric characters).
     * @param description The description of the item.
     * @param length The length of the item, in centimeters.
     * @param width The shortest dimension of the item, in centimeters.
     * @param height The longest dimension of the item, in centimeters
     * @param fcCode The unique identifier code for a fulfillment center 4-chars where first 3 are airport
     *               code for nearest city.
     */
    ...
    /**
     * Instantiates a new PrepareShipmentRequest object.
     * @param builder The Builder containing PrepareShipmentRequest data.
     */
